...
void analysis()
{
    ...
    std::string file = "/mnt/MainShare/Projects/Qichen/VBS/data/mc16_13TeV.364364.Sherpa_222_NNPDF30NNLO_lllljj_EW6_noHiggs.deriv.DAOD_HIGG2D1.e6611_e5984_a875_r10201_r10210_p3654.root";
    ROOT::RDataFrame frame("SM4L_Nominal",file);
    //cut
    ...
    TFile* out=new TFile("/mnt/MainShare/Projects/Qichen/VBS/output/85M.root","RECREATE");
    h_jj_m->Write();
    h_j3_pt->Write();
    h_j1_y->Write();
    h_j2_y->Write();
