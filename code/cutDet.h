...
std::vector<int> lepSel(std::vector<double> lepton_pt, 
                        std::vector<double> lepton_eta, 
                        std::vector<double> lepton_d0sig, 
                        std::vector<double> lepton_z0sinTheta, 
...
std::vector<int> lepTrueSel(std::vector<double> lepton_pt, 
                            std::vector<double> lepton_eta, 
                            std::vector<int> lepton_particleID)
{
    std::vector<int> letpon_pass_ind;
...
std::vector<int> jetSel(std::vector<double> jet_pt, std::vector<double> jet_eta)
{
...
std::vector<double> fpass_property(std::vector<int> index, std::vector<double> fproperty){
...
bool baseline(std::vector<int> lepton_pass_ind, std::vector<int> jet_pass_ind, std::vector<double> lepton_pt)
{
